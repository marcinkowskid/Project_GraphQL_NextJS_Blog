...
const PostCard = ({ post }) => {
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      ...
      <h1 className='text-center text-3xl font-semibold cursor-pointer mb-8 transition duration-500 hover:text-blue-600'>
        <Link href={`/post/${post.slug}`}>{post.title}</Link>
      </h1>
      <div className='block lg:flex text-center items-center justify-center mb-8 w-full'>
        <div className='flex items-center justify-center items-center mb-4 lg:mb-0 w-full lg:w-auto mr-8'>
          <Image
